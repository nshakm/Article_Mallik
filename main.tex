...
\clearpage
  ...
  \begin{itemize}
      \item{Observations display measurements of radii with conversion from Earth to Jupiter radii as $R_J = 10.97 R_{\oplus}$. This is the volumetric mean radius of Jupiter.}
      \item{\texttt{GASTLI} works with $R_J = 11.20 R_{\odot}$, which is the equatorial radius of Jupiter.}
  ...
  \begin{figure}[!h]
      ...
      \caption{Posterior distributions for the radius $R_p$ and bulk metallicity $Z_p$ from retrievals performed based on \texttt{GASTLI}. }
