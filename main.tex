...
\clearpage
  ...
  \subsection{Consistency in Scaling for Planetary Radius}
  % \begin{itemize}
  ...
  \begin{figure}[!h]
      ...
      of planet K2-114 b. Thesis results are in gray, while the internship ones are in red. Thesis: $R_p = 0.93^{+0.03}_{-0.03}\, R_J$, $Z_p = 0.30^{+0.07}_{-0.07}$. Internship: $R_p = 0.95^{+0.03}_{-0.03}\, R_J$, $Z_p = 0.26^{+0.08}_{-0.08}$.}
