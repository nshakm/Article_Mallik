...
\clearpage
  ...
  \begin{figure*}[!t]
      \centering
      \includegraphics[width=0.8\hsize]{fig/3.1_bulk_metallicity_comparison_3_datasets_paper.pdf}
...
\clearpage
  ...
  \begin{figure*}[!h]
      ...
      \caption{Relationship between bulk metallicity $Z_p$ and mass $M_p$ for retrievals using the tools \texttt{GASTLI} and \texttt{planetsynth}. TODO: perform regression and include parameter values!}
